...
namespace DataAccess
{
    public class Supplier
    {
        ...
        /// </summary>
        /// <param name="supplier">New Supplier</param>
        /// <returns>Số dòng được update</returns>
        ...
        public static List<Supplier> FindBy(object value, object cbbvalue)
        {
            string query = "Select * from Suppliers where " + cbbvalue + " like '" + value + "%'";
            return CBO.FillCollection<Supplier>(DataProvider.Instance.ExecuteReader(query));
        }
    }
}
