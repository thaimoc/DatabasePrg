...
namespace DataAccess
{
    public class Employee
    {
        ...
        public static List<Employee> FindBy(object value, object cbbvalue)
        {
            string query = "Select * from Employees where " + cbbvalue + " like '" + value + "%'";
            return CBO.FillCollection<Employee>(DataProvider.Instance.ExecuteReader(query));
        }
