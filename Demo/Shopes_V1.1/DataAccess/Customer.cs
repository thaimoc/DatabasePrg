...
namespace DataAccess
{
    public class Customer
    {
        ...
        //    return CBO.FillCollection<Customer>(DataProvider.Instance.ExecuteReader(expression));
        //}
        public static List<Customer> FindBy(object value, object cbbvalue)
        {
            string query = "Select * from Customers where " + cbbvalue + " like '" + value + "%'";
            return CBO.FillCollection<Customer>(DataProvider.Instance.ExecuteReader(query));
        }
        #endregion
    }
}
